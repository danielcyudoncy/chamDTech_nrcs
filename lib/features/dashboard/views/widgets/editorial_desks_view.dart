// features/dashboard/views/widgets/editorial_desks_view.dart
...
class EditorialDesksView extends StatelessWidget {
            ...
            if (controller.isLoadingDesks.value)
              ...
              GridView.builder(
                ...
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                  ...
                  childAspectRatio:
                      isMobile ? (Get.width < 600 ? 3.0 : 2.2) : 1.5,
                ),
                itemCount: controller.desks.length,
                itemBuilder: (context, index) =>
                    _buildDeskCard(controller.desks[index], controller),
              ),
          ],
        ),
      ),
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
                ...
                offset: isMobile ? const Offset(0, 8) : const Offset(0, 12))
          ],
          ...
          child: Stack(
            children: [
              Positioned(
                  ...
                  top: -20,
                  child: Icon(icon,
                      size: 140, color: color.withValues(alpha: 0.03))),
              Padding(
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              borderRadius:
                                  BorderRadius.circular(isMobile ? 10 : 18)),
                          child: Icon(icon,
                              color: color, size: isMobile ? 16 : 24),
                        ),
                        Container(
                          padding: const EdgeInsets.symmetric(
                          ...
                          child: Text('$scriptCount SCRIPTS',
                              style: TextStyle(
                                  fontSize: 10,
  ...
  Widget _buildDeskStoryList(DeskController controller) {
    final selectedDesk = controller.desks
        .firstWhere((d) => d.id == controller.selectedDeskId.value);
          ...
          child: Row(
            children: [
              IconButton(
                  ...
                  onPressed: () => controller.selectDesk('')),
              const SizedBox(width: 16),
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(selectedDesk.name.toUpperCase(),
                      style: TextStyle(
                          fontSize: 24,
                          fontWeight: FontWeight.w900,
                          color: color,
                          letterSpacing: -0.5)),
                  Text(
                      '${controller.deskStories.length} active scripts in this desk',
                      style:
          ...
          child: controller.deskStories.isEmpty
              ...
              : ListView.separated(
                  ...
                  separatorBuilder: (context, index) =>
                      const SizedBox(height: 12),
                  itemBuilder: (context, index) =>
                      _buildStoryTile(controller.deskStories[index]),
                ),
        ),
      ],
    );
        ...
        subtitle: Padding(
          ...
          child: Row(
            children: [
              ...
              const SizedBox(width: 4),
              Text(DateFormat('MMM dd, HH:mm').format(story.updatedAt),
                  style: TextStyle(color: Colors.grey.shade600, fontSize: 12)),
            ],
          ),
        ),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text('No scripts in this desk yet',
              style: TextStyle(
