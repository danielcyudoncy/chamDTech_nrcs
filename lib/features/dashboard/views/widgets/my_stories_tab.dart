      ...
      if (list.isEmpty) {
        return Center(
          child: Column(
            ...
            children: [
              Icon(group.icon, size: 48, color: Colors.grey.shade300),
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border.all(
          ...
          width: _showRevisionBanner ? 1.5 : 1,
        ),
        boxShadow: [
          BoxShadow(
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Action buttons
                if (_canEdit || _canSubmit || _canDelete) ...[
                  const SizedBox(height: 12),
